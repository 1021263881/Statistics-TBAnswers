...
public class TB
{
	...
	private String newNumber(int len)
	{
		return Tool.newNumber(len);
	}
	private String getMD5(String content) throws mException
	{
		return Tool.getMD5(content);
	}
	private String UrlEncodeUtf_8(String content) throws mException
	{
		return Urlcoder.UrlEncodeUtf_8(content);
	}
	private String UrlDecodeUtf_8(String content) throws mException
	{
		return Urlcoder.UrlDecodeUtf_8(content);
	}
	private String unixToStrTime(String content)
	{
		return Tool.unixToStrTime(content);
	}
}
